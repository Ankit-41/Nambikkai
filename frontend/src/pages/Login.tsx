...
import { hospitalAdminApi, doctorApi } from "../services/api"
...
const Login = () => {
  ...
  const [selectedPersona, setSelectedPersona] = useState<"patient" | "doctor" | "hospital-admin">("patient")
          ...
          <Card className="border border-gray-200 dark:border-gray-800 shadow-lg">
                ...
                {personas.map((persona) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-center p-3 rounded-lg border-2 transition-all duration-200 flex-1 ${
                        isSelected
                          ? persona.activeColor
                      ...
                      <div className="flex flex-col items-center space-y-2">
                        <div
                          className={`p-2 rounded-lg ${
                            isSelected ? "bg-white dark:bg-gray-800 shadow-sm" : "bg-gray-100 dark:bg-gray-800"
                          }`}
                        >
                          <Icon
                            className={`h-5 w-5 ${
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className={`w-full h-10 text-sm font-medium shadow-lg transition-all duration-200 ${
                    selectedPersona === "patient"
